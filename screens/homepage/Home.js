...
import MyPlaylistSubliminals from './MyPlaylistSubliminals';
...
const Home =({navigation}) =>{
    ...
    universalArray.pop()
          ...
          for(var i=0; i<object.info.length; i++){
            ...
            if(object.info.length==2){
              ...
              global.volume1="0."+object.info[0].audio_type.volume;
              global.type1=object.info[0].audio_type.name;
              global.track2=object.info[1].track_id;
              global.volume2="0."+object.info[1].audio_type.volume;
              ...
              global.volume3="0."+object.info[2].audio_type.volume;
              ...
              global.volume4="0."+object.info[3].audio_type.volume;
  ...
  const isLiked=()=>{
    if(global.liked==false){
      return(
        <TouchableOpacity onPress={()=>likeOrNot()} style={{marginLeft: 15, justifyContent: 'center', alignItems: 'center' }}>
          <Image source={{uri: 'https://cdn-icons-png.flaticon.com/128/1538/1538598.png'}} style={{  width: 30, height: 30,  tintColor: 'white', }} />
        </TouchableOpacity>
      )
    }else{
      return(
        <TouchableOpacity onPress={()=>likeOrNot()} style={{marginLeft: 15, backgroundColor: 'white', borderRadius: 20,  width: 30, height: 30, justifyContent: 'center', alignItems: 'center' }}>
          <Image source={{uri: 'https://cdn-icons-png.flaticon.com/128/1538/1538598.png'}} style={{  width: 22, height: 22,  tintColor: 'rgba(4,157,217,1)', }} />
        </TouchableOpacity>
      )
    }
  }  
