    ...
    return( 
      ...
      <ImageBackground source={require('../../assets/welcome1bg.png')} style={styles.container}>
        <FormContainer>
          ...
          {error ? (
          <View style={{ justifyContent: 'flex-end', alignItems: 'flex-end',bottom: 10, position: 'absolute', width: Dimensions.get('window').width, height: 30, shadowOpacity: 0.2, alignSelf: 'center'}}>
