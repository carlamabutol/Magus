        ...
        <ScrollView style={{marginBottom: space()}}>
          <View>
            <View style={{width: Dimensions.get('window').width-70, alignSelf: 'center'}}>
              ...
              <TouchableOpacity onPress={()=> navigation.navigate("MyPlaylist")} style={{flexDirection: 'row', marginTop: 19, }}>
                ...
                <Text style={{   fontSize: 15, color: '#0D0D0D', fontWeight: 'bold',left: 20, justifyContent: 'center', alignSelf: 'center'}} >Playlist</Text>
              ...
              <TouchableOpacity onPress={()=> navigation.navigate("MyPlaylist")} style={{flexDirection: 'row', marginTop: 10}}>
